# Generated by Django 4.2.13 on 2024-05-31 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', django.contrib.postgres.fields.ArrayField(base_field=object.models.PhoneNumberField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(regex='^\\+?1?\\d{9,15}$')]), blank=True, default=list, null=True, size=2, verbose_name='Номер телефона')),
